...
export const getStaticProps = async (ctx) => {
    ...
    try {
        ...
        const result = await axios.get(`https://zwallet.project-be.xyz/api/v1/transaction/detail/${id}`);
...
export const getStaticPaths = async () => {
    // const Url = process.env.api;
    const result = await axios.get(`https://zwallet.project-be.xyz/api/v1/transaction/detail/`);
